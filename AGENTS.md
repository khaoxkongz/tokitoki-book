...
- id: "@tanstack/devtools#devtools-app-setup"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools#devtools-app-setup"
...
- id: "@tanstack/devtools#devtools-marketplace"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools#devtools-marketplace"
...
- id: "@tanstack/devtools#devtools-plugin-panel"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools#devtools-plugin-panel"
...
- id: "@tanstack/devtools#devtools-production"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools#devtools-production"
...
- id: "@tanstack/devtools-event-client#devtools-bidirectional"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools-event-client#devtools-bidirectional"
...
- id: "@tanstack/devtools-event-client#devtools-event-client"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools-event-client#devtools-event-client"
...
- id: "@tanstack/devtools-event-client#devtools-instrumentation"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools-event-client#devtools-instrumentation"
...
- id: "@tanstack/devtools-vite#devtools-vite-plugin"
  run: "vp dlx @tanstack/intent@latest load @tanstack/devtools-vite#devtools-vite-plugin"
...
- id: "@tanstack/react-start#lifecycle/migrate-from-nextjs"
  run: "vp dlx @tanstack/intent@latest load @tanstack/react-start#lifecycle/migrate-from-nextjs"
...
- id: "@tanstack/react-start#react-start"
  run: "vp dlx @tanstack/intent@latest load @tanstack/react-start#react-start"
...
- id: "@tanstack/react-start#react-start/server-components"
  run: "vp dlx @tanstack/intent@latest load @tanstack/react-start#react-start/server-components"
...
- id: "@tanstack/router-core#router-core"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core"
...
- id: "@tanstack/router-core#router-core/auth-and-guards"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/auth-and-guards"
...
- id: "@tanstack/router-core#router-core/code-splitting"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/code-splitting"
...
- id: "@tanstack/router-core#router-core/data-loading"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/data-loading"
  for: "Route loader option, loaderDeps for cache keys, staleTime/gcTime/ defaultPreloadStaleTime SWR caching, pendingComponent/pendingMs/ pendingMinMs, errorComponent/onError/onCatch, beforeLoad, router context and createRootRouteWithContext DI pattern, router.invalidate, Await component, deferred data loading with unawaited promises."
- id: "@tanstack/router-core#router-core/navigation"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/navigation"
...
- id: "@tanstack/router-core#router-core/not-found-and-errors"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/not-found-and-errors"
...
- id: "@tanstack/router-core#router-core/path-params"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/path-params"
...
- id: "@tanstack/router-core#router-core/search-params"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/search-params"
...
- id: "@tanstack/router-core#router-core/ssr"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/ssr"
...
- id: "@tanstack/router-core#router-core/type-safety"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-core#router-core/type-safety"
  for: "Full type inference philosophy (never cast, never annotate inferred values), Register module declaration, from narrowing on hooks and Link, strict:false for shared components, getRouteApi for code-split typed access, addChildren with object syntax for TS perf, LinkProps and ValidateLinkOptions type utilities, as const satisfies pattern."
- id: "@tanstack/router-plugin#router-plugin"
  run: "vp dlx @tanstack/intent@latest load @tanstack/router-plugin#router-plugin"
...
- id: "@tanstack/start-client-core#start-core"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core"
...
- id: "@tanstack/start-client-core#start-core/auth-server-primitives"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core/auth-server-primitives"
...
- id: "@tanstack/start-client-core#start-core/deployment"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core/deployment"
...
- id: "@tanstack/start-client-core#start-core/execution-model"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core/execution-model"
...
- id: "@tanstack/start-client-core#start-core/middleware"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core/middleware"
...
- id: "@tanstack/start-client-core#start-core/server-functions"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core/server-functions"
...
- id: "@tanstack/start-client-core#start-core/server-routes"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-client-core#start-core/server-routes"
...
- id: "@tanstack/start-server-core#start-server-core"
  run: "vp dlx @tanstack/intent@latest load @tanstack/start-server-core#start-server-core"
...
- id: "@tanstack/virtual-file-routes#virtual-file-routes"
  run: "vp dlx @tanstack/intent@latest load @tanstack/virtual-file-routes#virtual-file-routes"
